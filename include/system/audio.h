...
typedef enum {
    ...
    AUDIO_SOURCE_REMOTE_SUBMIX       = 10, /* Source for the mix to be presented remotely.      */
...
typedef enum {
    ...
    AUDIO_DEVICE_OUT_FM_TX                     = 0x40000,
#endif
#endif
...
#endif
#ifdef QCOM_HARDWARE
    AUDIO_DEVICE_IN_PROXY                 = AUDIO_DEVICE_BIT_IN | 0x2000,
#ifdef QCOM_FM_ENABLED
    AUDIO_DEVICE_IN_FM_RX                 = AUDIO_DEVICE_BIT_IN | 0x4000,
    AUDIO_DEVICE_IN_FM_RX_A2DP            = AUDIO_DEVICE_BIT_IN | 0x8000,
#endif
#endif
